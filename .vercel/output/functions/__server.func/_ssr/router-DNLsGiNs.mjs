...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DNLsGiNs.js
var router_DNLsGiNs_exports = /* @__PURE__ */ __exportAll({
	a: () => getBaseURL,
	getRouter: () => getRouter,
	i: () => PACKAGE_VERSION,
	n: () => GROK_PROVIDERS,
...
var styles_default = "/assets/styles-CrQIWf7C.css";
var APP_NAME = "The Stargazer";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A 3D study of The Stargazer, the Early Bronze Age marble figurine in the Cleveland Museum of Art. Official photogrammetry mesh, CC0."
			},
			{
...
var $$splitComponentImporter$1 = () => import("./routes-CrLJiXdH.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-D3ior-ab.mjs");
...
//#endregion
export { router_DNLsGiNs_exports as a, getBaseURL as i, GROK_PROVIDERS as n, PACKAGE_VERSION as r, GENERIC_OAUTH_ERROR_CODES as t };
