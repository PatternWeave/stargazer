  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "A 3D study of The Stargazer, the Early Bronze Age marble figurine in the Cleveland Museum of Art. Official photogrammetry mesh, CC0.",
      },
